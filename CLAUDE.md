# [hwcloud-controlpanel] Go项目AI Agent协作指南
...
当被要求添加新功能时：你的第一步应该是先用 @ 指令阅读 internal/ 下的相关包，并对照项目目录下 constitution.md 的原则，然后再提出你的计划。